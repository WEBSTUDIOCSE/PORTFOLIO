// Shared social brand icons — used by the footer, the contact
// section, and anywhere else socials are listed, so the set stays
// consistent. All are 24×24, fill="currentColor", so they inherit
// text colour and size via className.
