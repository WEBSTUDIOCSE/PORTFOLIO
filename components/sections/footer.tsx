...
export default function Footer() {
  ...
  return (
    <footer className="footer-dotted-grid relative flex h-screen w-full flex-col justify-end overflow-hidden bg-[#fde047] px-4 pb-6 text-[#1a1a1a] md:px-10 md:pb-8">
